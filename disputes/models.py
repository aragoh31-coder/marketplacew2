...
class Dispute(PrivacyModel):
    ...
    complainant = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="filed_disputes"
    )
    respondent = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="received_disputes"
    )
...
class DisputeEvidence(PrivacyModel):
    ...
    file_attachment = models.FileField(
        upload_to="dispute_evidence/", blank=True, null=True
    )
