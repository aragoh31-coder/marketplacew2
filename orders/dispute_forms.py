...
class RaiseDisputeForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["title"].help_text = (
            "Provide a clear, concise title for your dispute"
        )
        self.fields["description"].help_text = (
            "Include all relevant details, dates, and circumstances"
        )
...
class DisputeEvidenceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["file"].help_text = (
            "Supported formats: Images (JPG, PNG, GIF), PDF, DOC, TXT. Max size: 10MB"
        )
...
class AdminDisputeResolutionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["resolution_notes"].help_text = (
            "This will be visible to both buyer and vendor"
        )
