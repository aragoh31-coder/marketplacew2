...
from .models import Dispute, DisputeEvidence, DisputeMessage, DisputeTimeline, Order
...
def dispute_detail(request, dispute_id):
    ...
    return render(
        ...
        "orders/dispute_detail.html",
        {
            ...
            "can_add_content": dispute.can_add_message(request.user)
...
def admin_dispute_resolution(request, dispute_id):
    ...
    return render(
        request, "admin/dispute_resolution.html", {"dispute": dispute, "form": form}
    )
...
def download_evidence(request, evidence_id):
    ...
    if (
        request.user not in evidence.dispute.get_participants()
...
def dispute_statistics_api(request):
    ...
    stats = {
        ...
        "disputes_last_30_days": Dispute.objects.filter(
