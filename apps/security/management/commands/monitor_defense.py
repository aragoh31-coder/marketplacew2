...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--interval", type=int, default=30, help="Report interval in seconds"
        )
    ...
    def get_comprehensive_stats(self):
        ...
        return {
            ...
            "threat_level": self.calculate_overall_threat_level(
                circuit_stats, resource_stats, security_stats
            ),
        }

    def calculate_overall_threat_level(
        self, circuit_stats, resource_stats, security_stats
    ):
        threat_score = 0
    ...
    def display_stats(self, stats):
        ...
        self.stdout.write(
            f"CPU: {resource_stats.get('cpu_percent', 0):.1f}% | "
        ...
        self.stdout.write(
            f"Requests/min: {security_stats.get('requests_per_minute', 0)} | "
        ...
        self.stdout.write(
            f"Active circuits: {circuit_stats.get('active_circuits', 0)} | "
