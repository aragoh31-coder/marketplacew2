...
class Command(BaseCommand):
    ...
    def clear_test_accounts(self):
        ...
        test_usernames = [
            'testbuyer1', 'testbuyer2', 'testbuyer3',
            'testvendor1', 'testvendor2', 'testvendor3',
    ...
    def create_vendor_accounts(self):
        ...
        for data in vendor_data:
            ...
            vendors.append(user)
            self.stdout.write(f"  ✅ Created vendor: {user.username} ({data['vendor_name']})")
...
-----END PGP PUBLIC KEY BLOCK-----"""
    ...
    def print_account_summary(self, buyers, vendors, admins):
        ...
        self.stdout.write("🌐 Access via: http://eo256pnscr5zd4bw2p4c24nrh2vntjhlcqxy5iluselu4mq7wgzt7sqd.onion")
