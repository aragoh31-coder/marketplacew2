...
class AuditLogger:
    ...
    def log_user_action(self, user, action, details=None, request=None, risk_level='low'):
    ...
    def log_security_event(self, event_type, risk_level, details=None, user=None, request=None):
        """Log security events"""
        try:
            log_data = {
                'timestamp': timezone.now().isoformat(),
    ...
    def log_transaction(self, transaction_type, amount, currency, user=None, details=None):
    ...
    def log_admin_action(self, admin_user, action, target=None, details=None, request=None):
