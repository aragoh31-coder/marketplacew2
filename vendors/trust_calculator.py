...
class VendorTrustCalculator:
    ...
    def calculate_trust_score(cls, vendor):
        ...
        try:
            ...
            if total_orders > 0:
                completed_orders = vendor.vendor_orders.filter(
                    status="completed"
                ).count()
            ...
            factors["feedback"] = {
                "score": feedback_score,
                "rating": getattr(vendor, "feedback_score", 0),
            }
            ...
            score += dispute_score
            factors["dispute_rate"] = {"score": dispute_score, "rate": dispute_rate}
            ...
            score += volume_score
            factors["volume"] = {"score": volume_score, "recent_orders": recent_orders}
            ...
            return {"trust_score": 0, "trust_level": "new", "error": str(e)}
    ...
    def update_vendor_trust(cls, vendor):
        ...
        try:
            ...
            logger.info(
                f"Updated trust for vendor {vendor.id}: {trust_data['trust_score']} ({trust_data['trust_level']})"
            )
