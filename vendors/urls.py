...
urlpatterns = [
    ...
    path(
        "products/<uuid:product_id>/toggle/",
    ...
    path(
        "subvendors/<uuid:subvendor_id>/edit/",
        views.edit_subvendor,
        name="edit_subvendor",
    ),
    path(
        "subvendors/<uuid:subvendor_id>/deactivate/",
        views.deactivate_subvendor,
        name="deactivate_subvendor",
    ),
    path(
        "subvendors/<uuid:subvendor_id>/activity/",
        views.subvendor_activity_log,
        name="subvendor_activity_log",
    ),
