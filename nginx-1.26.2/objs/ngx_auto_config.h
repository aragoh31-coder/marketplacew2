#define NGX_CONFIGURE " --prefix=/workspace/nginx --with-pcre=/workspace/pcre --with-http_gzip_static_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "clang 20.1.2 (0ubuntu1)"
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/workspace/nginx/"
#endif
