...
if not token or token == "" then
    ngx.log(ngx.INFO, "HMAC gatekeeper: No token found, redirecting to challenge")
    return ngx.redirect("/anti_ddos/challenge/")
end

ngx.log(ngx.INFO, "HMAC gatekeeper: Token present, allowing request")
